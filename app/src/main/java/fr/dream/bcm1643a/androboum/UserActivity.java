...
public class UserActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (auth.getCurrentUser() != null) {
            ...
            tvUserMail.setText(auth.getCurrentUser().getEmail());
        ...
        ImageView imageView = (ImageView) findViewById(R.id.userProfil);
        ...
        Button listUser = findViewById(R.id.userList);
        ...
        if (requestCode == RC_SIGN_IN) {
            ...
            if (resultCode == RESULT_OK) {
                Log.v("AndroBoum", "je me suis connecté et mon email est :" +
                        response.getEmail());
                TextView tvUserMail = findViewById(R.id.tvUserMail);
                tvUserMail.setText(response.getEmail());
                downloadImage();
                setUser();
                updateProfil(user);
                return;
